...
async function processaCadastro(e=null) {
    e.preventDefault();
    await verificaLogin();
...
function removeProd(idpro=null) {
...
function mostrarDados(data) {
    ...
    data.forEach(obj => {
        ...
        row += `<td><button onclick="removeProd(${obj.id_prod})" id="bt_rm_${obj.id_prod}" title='Remover este item.' >
                        &#128465</button>
