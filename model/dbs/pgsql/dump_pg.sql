...
-- Started on 2019-09-21 20:57:15 -03
...
--
-- TOC entry 198 (class 1259 OID 16699)
...
--
-- TOC entry 199 (class 1259 OID 16702)
...
--
-- TOC entry 202 (class 1259 OID 16710)
-- Name: prod_ext_id_ext_seq; Type: SEQUENCE; Schema: public; Owner: root
--

CREATE SEQUENCE public.prod_ext_id_ext_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.prod_ext_id_ext_seq OWNER TO root;

--
-- TOC entry 2988 (class 0 OID 0)
-- Dependencies: 202
-- Name: prod_ext_id_ext_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: root
--

ALTER SEQUENCE public.prod_ext_id_ext_seq OWNED BY public.prod_ext.id_ext;


--
-- TOC entry 203 (class 1259 OID 16712)
-- Name: prod_ext_id_prod_seq; Type: SEQUENCE; Schema: public; Owner: root
--

CREATE SEQUENCE public.prod_ext_id_prod_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.prod_ext_id_prod_seq OWNER TO root;

--
-- TOC entry 2989 (class 0 OID 0)
-- Dependencies: 203
-- Name: prod_ext_id_prod_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: root
--

ALTER SEQUENCE public.prod_ext_id_prod_seq OWNED BY public.prod_ext.id_prod;
...
--
-- TOC entry 205 (class 1259 OID 16722)
...
--
-- TOC entry 2829 (class 2604 OID 16724)
...
--
-- TOC entry 2830 (class 2604 OID 16725)
...
--
-- TOC entry 2831 (class 2604 OID 16726)
-- Name: prod_ext id_prod; Type: DEFAULT; Schema: public; Owner: root
--

ALTER TABLE ONLY public.prod_ext ALTER COLUMN id_prod SET DEFAULT nextval('public.prod_ext_id_prod_seq'::regclass);


--
-- TOC entry 2832 (class 2604 OID 16727)
-- Name: prod_ext id_ext; Type: DEFAULT; Schema: public; Owner: root
--

ALTER TABLE ONLY public.prod_ext ALTER COLUMN id_ext SET DEFAULT nextval('public.prod_ext_id_ext_seq'::regclass);


--
-- TOC entry 2835 (class 2604 OID 16728)
...
--
-- TOC entry 2971 (class 0 OID 16693)
-- Dependencies: 196
...
--
-- TOC entry 2973 (class 0 OID 16699)
-- Dependencies: 198
...
--
-- TOC entry 2975 (class 0 OID 16704)
-- Dependencies: 200
...
--
-- TOC entry 2976 (class 0 OID 16707)
-- Dependencies: 201
...
--
-- TOC entry 2979 (class 0 OID 16714)
-- Dependencies: 204
...
SELECT pg_catalog.setval('public.descontos_id_desc_seq', 1, false);
...
SELECT pg_catalog.setval('public.extras_id_ext_seq', 1, false);


--
-- TOC entry 2993 (class 0 OID 0)
-- Dependencies: 202
-- Name: prod_ext_id_ext_seq; Type: SEQUENCE SET; Schema: public; Owner: root
--

SELECT pg_catalog.setval('public.prod_ext_id_ext_seq', 1, false);


--
-- TOC entry 2994 (class 0 OID 0)
-- Dependencies: 203
-- Name: prod_ext_id_prod_seq; Type: SEQUENCE SET; Schema: public; Owner: root
--

SELECT pg_catalog.setval('public.prod_ext_id_prod_seq', 1, false);
...
SELECT pg_catalog.setval('public.produtos_id_prod_seq', 1, false);


--
-- TOC entry 2837 (class 2606 OID 16730)
...
--
-- TOC entry 2839 (class 2606 OID 16732)
...
--
-- TOC entry 2841 (class 2606 OID 16734)
...
--
-- TOC entry 2843 (class 2606 OID 16736)
...
--
-- TOC entry 2845 (class 2606 OID 16738)
...
--
-- TOC entry 2846 (class 2606 OID 16739)
...
--
-- TOC entry 2847 (class 2606 OID 16744)
...
--
-- TOC entry 2848 (class 2606 OID 16749)
...
--
-- TOC entry 2849 (class 2606 OID 16754)
...
-- Completed on 2019-09-21 20:57:15 -03
